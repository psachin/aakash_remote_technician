# Django settings for aakash_remote_technician project.
...
SECRET_KEY = 'wad4^xov@#*g32=l+sfmjk9es*7fexto+%#7f7tfr0q#$4!bry'
...
WSGI_APPLICATION = 'aakash_remote_technician.wsgi.application'
